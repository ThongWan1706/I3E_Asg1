...
* Date: 9 Jun 2026
* Description: This code is specifically for the white card where players will be collecting it at lvl 3 in order to open the door
*/
...
{
    //Item Settings
    public string cardType = "White"; // "Blue", "Red", or "Security"
    ...
    public string pickupPrompt = "Press 'F' to pick up White Keycard";
